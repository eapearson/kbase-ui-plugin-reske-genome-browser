// FORKED off prior to adding wedges
define([
    'knockout-plus',
    'numeral',
    'kb_common/html'
    ...
    */
    ...
    function viewModel(params) {
        ...
        var arg2 = {
            ...
            termTypes: {
                kbase: ko.observable(makeRingWithTick('kbase', 0)),
                community: ko.observable(makeRingWithTick('community', 1)),
        ...
        params.vm.termRelations.subscribe(function() {
            ...
            ['kbase', 'community', 'expression', 'fitness'].forEach(function(termType, index) {
